...
class MtlNetwork_body(Model): # Vitamon network except inception layer
    ...
    def __init__(self, num_classes = 128):
        ...
        self.fc1_2 = layers.Dense(num_classes, activation=tf.nn.relu) # changed from 512
...
class MtlNetwork_body2(Model): # Vitamon network except inception layer
    # Set layers.
    def __init__(self, num_classes = 128):
        super(MtlNetwork_body2, self).__init__()
        # Convolution Layer with 32 filters and a kernel size of 5.
        self.conv1 = ConvBNRelu(32)
        ...
        self.fc1_2 = layers.Dense(num_classes, activation=tf.nn.tanh) # changed from 512
