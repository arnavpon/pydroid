...
path_dir = '../../../../../../../project_rppg/Codes/subject_001/trial_001/video/'
...
if not os.path.exists('./nn_weights/sub1'):
    os.mkdir('./nn_weights/sub1')
neural_net1.save_weights('./nn_weights/sub1/weights')
...
neural_net1.load_weights('./nn_weights/sub1/weights')
